...
class FacebookVidSpider(scrapy.Spider):
    ...
    def __init__(self, level, *args, **kwargs):
        ...
        self.log_folder = LOG_FOLDER + str(level) + '/'
    ...
    def start_requests(self):
        while True:
            ...
            for video_log in glob.glob( log_folder + '*'):
                print video_log
                loc_time = time.time()
    ...
    def pull_video_data(self, response):
        ...
        'stream_type', 'hd_tag', 'hd_tag', 'minQuality', 'maxQuality', 'sd_src', 'hd_src', 'isPage', 'page_gen_time', 'islivestreaming', 'ownerName', 'isLiveVOD', 'vip'
        'video_id', 'video_url', 'video_channel_id']
        ...
        if not os.path.isfile( f_name):
            ...
            if vid_raw_url:
                yield scrapy.Request( vid_raw_url,  
